package com.example.prodcuts.controller;
...
import com.example.prodcuts.service.SortParserService;
import com.example.prodcuts.service.mapper.DtoMapper;
...
public class ProductController {
    ...
    @GetMapping("/test")
    public String get() {
        productService.save(new Product("iPhone A", new BigDecimal("1000")));
        productService.save(new Product("iPhone B", new BigDecimal("2000")));
        productService.save(new Product("iPhone C", new BigDecimal("100")));
        productService.save(new Product("iPhone D", new BigDecimal("22000")));
        productService.save(new Product("iPhone E", new BigDecimal("1500")));
        return "Done";
    }
}
